...
<title id="Timerhead">Štampanje profakturi за най-префърцунените - Land of Roses doo: baza podataka</title>
...
while($row=$result->fetch_assoc()) {
	...
	echo '<a href="ajax/profakturapa3.php?posebno='.$ID.'&redova=0" target="_blank">'.$brpracuna.'</a><br/>';
}
?>
		</div>
	</div>
