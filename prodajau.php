...
?>
	...
	<div class="iur">
		...
		<input id="ybrracunau" type="text" name="brracunau" class="iud" value="220-130624-03" />
		<div style="clear:both;"></div>
	</div>
	<div class="iur">
...
function izmena(posebno,skladiste)
	{
		...
		$.getJSON('ajax/prodajaup.php', {posebno: posebno, skladiste: skladiste}, function(data) {
...
function proizvodi(xx)
	{
		var skladiste = document.getElementById("yskladiste").value;
		var osoba= document.getElementById("ykupac").value;
		$.getJSON('ajax/prodajaup.php', {posebno: xx, skladiste: skladiste, osoba: osoba}, function(data) {
			$('#trecakolona').html(data.ysortostali);
			$('#desnakolona').html(data.ysorttu);
