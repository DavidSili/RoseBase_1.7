...
<title id="Timerhead">Skladišta - Land of Roses doo: baza podataka</title>
...
echo $ID;
	...
	<div class="iur">
		<div class="iul">Odgovorna osoba</div>
...
?>
	...
	<div class="iur">
		...
		<textarea id="yadresa" style="width:153px" rows="3" name="adresa" class="iud"></textarea>
		<div style="clear:both;"></div>
	</div>
	<div class="iur">
...
function adresa2()
	{
		var adresa = document.getElementById("yoosoba").value;
		$.getJSON('ajax/skladistaa.php', {posebno: adresa}, function(data) {
...
function izmena(posebno)
	{
		...
		$.getJSON('ajax/skladistai.php', {posebno: posebno}, function(data) {
			$('#yid').val(data.yid);
			$('#ynaziv').val(data.ynaziv);
			$('#yoosoba').val(data.yoosoba);
			$('#yadresa').val(data.yadresa);
