...
<title id="Timerhead">Štampanje fakturi за най-префърцунените - Land of Roses doo: baza podataka</title>
...
while($row=$result->fetch_assoc()) {
	...
	echo '<a href="ajax/fakturapa3.php?posebno='.$ID.'&redova=0" target="_blank">'.$brracuna.'</a><br/>';
}
?>
		</div>
	</div>
