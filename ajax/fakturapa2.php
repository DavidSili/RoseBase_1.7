...
<title id="Timerhead">Faktura за префърцунените - Land of Roses doo: baza podataka</title>
...
$sve='';
if ($brstranica==1) {
$sve.='<table style="font-size:12" border="1"><tr style="background:#ddd"><th style="width:16px">Br.</th><th style="width:50px">Šifra proizvoda</th><th>Vrsta robe - usluga</th><th style="width:20px">Kol.</th><th>JM</th><th style="width:68px">MPC</th><th style="width:68px">VPC</th><th style="width:40px">Rabat</th><th style="width:74px">Osnovica</th><th style="width:62px">PDV</th><th style="width:74px">Ukupno</th></tr>';
