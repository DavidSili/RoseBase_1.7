...
<title id="Timerhead">Profaktura за най-префърцунените - Land of Roses doo: baza podataka</title>
...
if ($brstranica==1) {
$sve='<table style="font-size:12" border="1"><tr style="background:#ddd"><th stlye="width:16px">Br.</th><th style="width:50px">Bar kod</th><th>Vrsta robe - usluga</th><th style="width:20px">Kol.</th><th>JM</th><th style="width:68px">MPC</th><th style="width:68px">VPC</th><th style="width:40px">Rabat</th><th style="width:74px">Osnovica</th><th style="width:62px">PDV 20%</th><th style="width:74px">Ukupno</th></tr>';
...
$sve.='</table>';
	...
	foreach($redovi as $xx => $yy) {
		$stranicabr=$xx+1;
		$sve[$stranicabr]='<table style="font-size:12" border="1"><tr style="background:#ddd"><th stlye="width:16px">Br.</th><th style="width:50px">Bar kod</th><th>Vrsta robe - usluga</th><th style="width:20px">Kol.</th><th>JM</th><th style="width:68px">MPC</th><th style="width:68px">VPC</th><th style="width:40px">Rabat</th><th style="width:74px">Osnovica</th><th style="width:68px">PDV 20%</th><th style="width:74px">Vred. sa PDV</th></tr>';
