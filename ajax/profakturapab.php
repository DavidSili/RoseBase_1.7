...
<title id="Timerhead">Profaktura - Land of Roses doo: baza podataka</title>
...
if ($brstranica==1) {
$sve='<table style="font-size:12" border="1"><tr style="background:#ddd"><th stlye="width:16px">Br.</th><th style="width:50px">Šifra proizvoda</th><th>Vrsta robe - usluga</th><th style="width:20px">Kol.</th><th>JM</th><th style="width:68px">Cena</th><th style="width:40px">R %</th><th style="width:74px">Ukupno</th></tr>';
...
$sve.='</table>';
	...
	$desnibox='<b>Račun otpremnica: '.$brpracuna.'</b><br/><br/><b>Rok plaćanja: '.$rok.'</b><br/>Datum prometa: '.$datprometa.'<br/><br/><b>TR: 180-1281210042203-84</b><br/><b>Poziv: '.$pozivnb.'</b><br/>* Izdavalac računa nije obveznik pdv-a';
	$dolbox=$bezpopusta.' RSD<br/>'.$popust.' RSD<br/>'.$zauplatu.' RSD';
