...
<title id="Timerhead">Štampanje fakturi за префърцунените - Land of Roses doo: baza podataka</title>
...
while($row=mysql_fetch_assoc($result)) {
	...
	echo '<a href="ajax/fakturapa2.php?posebno='.$ID.'&redova=0" target="_blank">'.$brracuna.'</a><br/>';
}
?>
		</div>
	</div>
