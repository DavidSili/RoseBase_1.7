...
<title id="Timerhead">Štampanje fakturi - Land of Roses doo: baza podataka</title>
...
while($row=mysql_fetch_assoc($result)) {
	...
	echo '<a href="ajax/fakturapa.php?posebno='.$ID.'&redova=0" target="_blank">'.$brracuna.'</a><br/>';
}
?>
		</div>
	</div>
...
while($row=mysql_fetch_assoc($result)) {
	...
	echo '<a href="ajax/fakturapab.php?posebno='.$ID.'&redova=0" target="_blank">'.$brracuna.'</a><br/>';
}
?>
		</div>
	</div>
