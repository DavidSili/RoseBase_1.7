...
<title id="Timerhead">Štampanje izveštaja međuskladišnica - Land of Roses doo: baza podataka</title>
...
while($row=mysql_fetch_assoc($result)) {
	...
	echo '<a href="ajax/izvmsklada.php?posebno='.$idmsklad.'&redova=0" target="_blank">'.$idmsklad.' - '.$datum.'</a><br/>';
}
?>
		</div>
	</div>
