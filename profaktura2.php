...
<title id="Timerhead">Štampanje profakturi за префърцунените - Land of Roses doo: baza podataka</title>
...
while($row=mysql_fetch_assoc($result)) {
	...
	echo '<a href="ajax/profakturapa2.php?posebno='.$ID.'&redova=0" target="_blank">'.$brpracuna.'</a><br/>';
}
?>
		</div>
	</div>
