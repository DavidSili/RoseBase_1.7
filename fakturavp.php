...
<title id="Timerhead">Štampanje fakturi za veleprodaju - Land of Roses doo: baza podataka</title>
...
while($row=$result->fetch_assoc()) {
	...
	echo '<a href="ajax/fakturavpa.php?posebno='.$ID.'&redova=0" target="_blank">'.$brracuna.'</a><br/>';
}
?>
		</div>
	</div>
